...
export const JOBS = [
  ...
  { name: 'announce.ingest', everyMs: 15_000, needs: 'channel', load: () => import('../modules/announce/index.js'), fn: 'ingestOnce' },
  { name: 'announce.flush', everyMs: 30_000, needs: 'channel', load: () => import('../modules/announce/index.js'), fn: 'flushAggregates' },
  { name: 'announce.dispatch', everyMs: 10_000, needs: 'channel', load: () => import('../modules/announce/index.js'), fn: 'processOutboxOnce' },
